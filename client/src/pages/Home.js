          ...
          <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            {/* TODO: fix card spacing of create/posts/sell */}
              <div>
                ...
                <h3 class="mb-2 text-xl font-bold text-white">Create a custom profile</h3>
              ...
              <div>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Share posts of your favorite plants</h3>
